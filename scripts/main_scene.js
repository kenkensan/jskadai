...
class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(randx, randy, 'alien1');
        // 星を(200,200)に追加
        let randx2 = Phaser.Math.Between(50, 750) ; // y は　50～750の間の値
        let randy2 =  Phaser.Math.Between(50, 200) ;  // y は　50～200の間の値
        
        this.player = this.add.image(500, 350, 'alien2');
        this.player2 = this.add.image(500, 350, 'alien1');
